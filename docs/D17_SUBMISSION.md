...
changelog = "Version 1.1.2 removes redundant FC projection breakdown lines to reduce scrolling, while retaining estimate details in the expanded table and tooltips."
```
