...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("0.5.47.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("Fixes cramped submarine names", repoManifest.GetProperty("Changelog").GetString());
