...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("0.5.46.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("Restores Operations fleet column titles", repoManifest.GetProperty("Changelog").GetString());
