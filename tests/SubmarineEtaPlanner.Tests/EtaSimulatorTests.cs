...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("0.5.48.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("Balances Income fleet columns", repoManifest.GetProperty("Changelog").GetString());
