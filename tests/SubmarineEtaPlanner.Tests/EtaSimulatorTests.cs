...
public sealed class EtaSimulatorTests
{
    ...
    public void RepoJsonContainsExpectedDownloadLinks()
    {
        ...
        Assert.Contains("\"AssemblyVersion\": \"0.4.17.0\"", repoJson);
        ...
        Assert.Contains("https://alexvalliere.github.io/submarineEtaPlanner/images/icon-0.4.17.0.png", repoJson);
        ...
        Assert.Contains("Fixed a dashboard crash caused by transient SubmarineTracker data", repoJson);
    ...
    public void VersionedPluginIconIsValidAndPublishedByPagesWorkflow()
    {
        ...
        Assert.Contains("Copy-Item images/icon.png public/images/icon-0.4.17.0.png", workflow);
