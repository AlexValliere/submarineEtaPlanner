...
public sealed class EtaSimulatorTests
{
    ...
    public void RepoJsonContainsExpectedDownloadLinks()
    {
        ...
        Assert.Contains("\"AssemblyVersion\": \"0.4.7.0\"", repoJson);
        ...
        Assert.Contains("https://alexvalliere.github.io/submarineEtaPlanner/images/icon-0.4.7.0.png", repoJson);
        ...
        Assert.Contains("voyage forecast tables", repoJson);
    ...
    public void VersionedPluginIconIsValidAndPublishedByPagesWorkflow()
    {
        ...
        Assert.Contains("Copy-Item images/icon.png public/images/icon-0.4.7.0.png", workflow);
