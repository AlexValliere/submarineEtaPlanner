...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("0.5.37.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("Leveling fleet rows", repoManifest.GetProperty("Changelog").GetString());
