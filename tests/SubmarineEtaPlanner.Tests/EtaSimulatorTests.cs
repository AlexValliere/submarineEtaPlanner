...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("1.0.2.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("always showing the year", repoManifest.GetProperty("Changelog").GetString());
