...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("1.0.1.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("minimum averaging period of 24 hours", repoManifest.GetProperty("Changelog").GetString());
