...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("0.5.45.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("Compact fleet overview", repoManifest.GetProperty("Changelog").GetString());
