...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("0.5.52.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("adjustable rolling return window", repoManifest.GetProperty("Changelog").GetString());
