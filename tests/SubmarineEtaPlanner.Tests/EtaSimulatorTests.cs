...
public sealed class EtaSimulatorTests
{
    ...
    public void PublicPluginManifestsKeepPositioningAndIdentityInSync()
    {
        ...
        Assert.Equal("0.5.38.0", repoManifest.GetProperty("AssemblyVersion").GetString());
        ...
        Assert.Contains("tracked salvaged accessories", repoManifest.GetProperty("Changelog").GetString());
